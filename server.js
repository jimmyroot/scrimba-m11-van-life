...
createServer({
    ...
    seeds(server) {
        ...
        server.create("user", { id: "123", email: "j@n.com", password: "abc123", name: "Jimmy"})
    },
    ...
    routes() {
        ...
        // Passthrough for firestore requests
        ...
        this.post("/login", (schema, request) => {
            ...
            if (!foundUser) {
                return new Response(401, {}, { message: "No user with those credentials exists! "})
            }
